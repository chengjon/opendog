...
| Retained-evidence lifecycle | `FT-01.04.05` | Which OPENDOG-retained evidence should I prune, and is `VACUUM` worth it? | `get_activity_rollups` for post-cleanup volume checks; cleanup execution is CLI-only | `opendog cleanup-data` | [JSON Contracts](./json-contracts.md), [README](../README.md) |
