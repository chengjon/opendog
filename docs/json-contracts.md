...
- Extended MCP/governance JSON contracts: [MCP and Governance Contracts](./json-contracts-mcp-governance.md)
...
## Extended MCP, Verification, Governance, and Service Contracts

The detailed contracts below moved to [JSON Contracts: MCP and Governance](./json-contracts-mcp-governance.md) to keep this root contract index readable while preserving top-level entry points.

## MCP Resources

Moved to [MCP Resources](./json-contracts-mcp-governance.md).

## `opendog record-verification --json`

Moved to [`opendog record-verification --json`](./json-contracts-mcp-governance.md).

## `opendog run-verification --json`

Moved to [`opendog run-verification --json`](./json-contracts-mcp-governance.md).

## `opendog create-governance-lane --json` / MCP `create_governance_lane`

Moved to [`create-governance-lane` / `create_governance_lane`](./json-contracts-mcp-governance.md).

## `opendog upsert-governance-node --json` / MCP `upsert_governance_node`

Moved to [`upsert-governance-node` / `upsert_governance_node`](./json-contracts-mcp-governance.md).

## `opendog get-governance-state --json` / MCP `get_governance_state`

Moved to [`get-governance-state` / `get_governance_state`](./json-contracts-mcp-governance.md).

## `opendog close-governance-lane --json` / MCP `close_governance_lane`

Moved to [`close-governance-lane` / `close_governance_lane`](./json-contracts-mcp-governance.md).

## MCP `scan_orphans`

Moved to [MCP `scan_orphans`](./json-contracts-mcp-governance.md).

## MCP `verify_deletion_plan`

Moved to [MCP `verify_deletion_plan`](./json-contracts-mcp-governance.md).

## MCP Service Contracts

Moved to [MCP Service Contracts](./json-contracts-mcp-governance.md).

## MCP Error Contract

Moved to [MCP Error Contract](./json-contracts-mcp-governance.md).
...
- [MCP and Governance JSON Contracts](./json-contracts-mcp-governance.md)
- [README](../README.md)
- [CLAUDE.md](../CLAUDE.md)
