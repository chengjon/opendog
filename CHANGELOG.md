...
- Machine-readable `execution_sequence` payloads for repository stabilization and verification-first workflows, including resume conditions and suggested follow-up commands.
...
- Guidance and decision payloads now summarize which projects require repository stabilization, fresh verification runs, or failing-verification repair before broader cleanup or refactor review.
...
- This hardening line completed the current deepening slice across `FT-03.02.02`, `FT-03.03.01`, `FT-03.06.01`, and `FT-03.07.01`.
