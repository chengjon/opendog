...
This project is indexed by GitNexus as **opendog** (8868 symbols, 19465 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
