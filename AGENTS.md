...
This project is indexed by GitNexus as **opendog** (8833 symbols, 19423 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
