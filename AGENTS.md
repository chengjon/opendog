...
This project is indexed by GitNexus as **opendog** (8707 symbols, 19161 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
