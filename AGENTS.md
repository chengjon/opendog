...
This project is indexed by GitNexus as **opendog** (8774 symbols, 19310 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
