use opendog::contracts::{
    CLI_ACTIVITY_ROLLUPS_V1, CLI_CLEANUP_PROJECT_DATA_V1, CLI_DECISION_BRIEF_V1,
    CLI_GLOBAL_CONFIG_V1, CLI_PROJECT_CONFIG_V1, CLI_RELOAD_PROJECT_CONFIG_V1,
    CLI_SNAPSHOT_COMPARE_V1, CLI_TIME_WINDOW_REPORT_V1, CLI_UPDATE_GLOBAL_CONFIG_V1,
    CLI_UPDATE_PROJECT_CONFIG_V1, CLI_USAGE_TRENDS_V1,
};
