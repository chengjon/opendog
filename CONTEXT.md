...
- MCP evidence payload modules should move toward typed internal models with JSON builders as adapters. Storage-maintenance candidate assessment and workspace aggregation now have typed models; continue with storage-maintenance execution-template inputs and verification-evidence payloads.
