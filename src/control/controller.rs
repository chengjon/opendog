...
pub struct MonitorController {
    pub(super) pm: ProjectManager,
    pub(super) monitors: HashMap<String, MonitorHandle>,
}
...
impl MonitorController {
    ...
    pub(super) fn with_project_db<F, T>(&self, id: &str, f: F) -> crate::error::Result<T>
    where
    ...
    pub(super) fn with_project_info_db<F, T>(&self, id: &str, f: F) -> crate::error::Result<T>
    where
